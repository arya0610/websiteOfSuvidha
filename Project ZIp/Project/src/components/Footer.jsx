    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex flex-1 flex-col justify-start mr-10">
          ...
          SUVIDHAA BNK is a reliable online B2B platform. Under this platform we partner with neighbourhood
          retail stores who can offer digital financial services through our web based application or mobile application.
          </p>
        </div>
      ...
      >
        <p className="text-white text-[15px] font-normal font-poppins leading-5">
          Copyright ©{year} Suvidha BNK. All rights reserve, Desigend an developed by Miss Arya choubey.
        </p>
